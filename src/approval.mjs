...
export const PROTOCOL = [
  ...
  "   Each offers 2-4 model options chosen for THAT agent out of haiku / sonnet / opus /",
  "   fable / inherit / skip. Four is a hard cap, so offer haiku on small tasks and fable",
  "   on large ones rather than listing every model. Keep skip: it is the only veto.",
  "   Put your recommendation first, labelled '<model> (Recommended)', and bias it cheap.",
